...
<main style="min-height: 60vh; padding-top: 50px; padding-bottom: 50px;">
    <?php 
        // Tự động nhận diện trang khách hàng muốn xem
        $page = isset($_GET['p']) ? $_GET['p'] : 'gioi-thieu'; 
    ?>

    <?php if ($page === 'gioi-thieu'): ?>
        <div class="container">
            <h2 style="color: #2c5e31; font-weight: bold; text-align: center; margin-bottom: 30px; text-transform: uppercase;">Giới Thiệu</h2>
            <div class="row align-items-center">
                <div class="col-md-6 mb-4">
                    <div style="width: 100%; height: 350px; background-color: #e8f5e9; border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                        <i class="fa-solid fa-seedling" style="font-size: 80px; color: #6aa173;"></i>
                    </div>
                </div>
                <div class="col-md-6">
                    <h3 class="mb-3" style="color: #6aa173;">Chào mừng đến với THE TREE</h3>
                    <p style="line-height: 1.8;">Bắt nguồn từ tình yêu mãnh liệt với thiên nhiên, THE TREE được thành lập với sứ mệnh mang mảng xanh đến mọi không gian sống.</p>
                    <p style="line-height: 1.8;">Dù bạn là người mới bắt đầu hay dân chơi Bonsai chuyên nghiệp, The Tree luôn cam kết cung cấp những chậu cây khỏe mạnh, đã được thuần dưỡng kỹ lưỡng kèm theo sự hỗ trợ tận tâm trọn đời.</p>
                </div>
            </div>
        </div>

    <?php elseif ($page === 'tin-tuc'): ?>
        <div class="container">
            <h2 style="color: #2c5e31; font-weight: bold; text-align: center; margin-bottom: 30px; text-transform: uppercase;">Góc Mảng Xanh</h2>
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            <h5 class="card-title" style="font-weight: bold;">Bí quyết chăm sóc Bonsai</h5>
                            <p class="text-muted">15/04/2026</p>
                            <p class="card-text">Việc chăm sóc bonsai không hề khó nếu nắm vững 3 quy tắc cơ bản về tưới nước, ánh sáng và cắt tỉa...</p>
                            <button class="btn btn-outline-success btn-sm">Đọc tiếp</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            <h5 class="card-title" style="font-weight: bold;">Cây thanh lọc không khí</h5>
                            <p class="text-muted">10/04/2026</p>
                            <p class="card-text">Tham khảo 5 loại cây "thần dược" giúp lọc không khí, giảm căng thẳng khi làm việc tại văn phòng...</p>
                            <button class="btn btn-outline-success btn-sm">Đọc tiếp</button>
                        </div>
                    </div>
                </div>
    ...
    <?php elseif ($page === 'lien-he'): ?>
        <div class="container">
            <h2 style="color: #2c5e31; font-weight: bold; text-align: center; margin-bottom: 30px; text-transform: uppercase;">Liên Hệ</h2>
            <div class="row">
                <div class="col-md-5 mb-4">
                    <p><i class="fa-solid fa-location-dot me-2 text-success"></i> <strong>Địa chỉ:</strong> 123 Đường Xanh, TP.HCM</p>
                    <p><i class="fa-solid fa-phone me-2 text-success"></i> <strong>Hotline:</strong> 0909 123 456</p>
                    <p><i class="fa-solid fa-envelope me-2 text-success"></i> <strong>Email:</strong> hotro@thetree-bonsai.vn</p>
                </div>
                <div class="col-md-7">
                    <div class="card shadow-sm border-0 p-4">
                        <form>
                            <input type="text" class="form-control mb-3" placeholder="Họ và tên của bạn...">
                            <textarea class="form-control mb-3" rows="3" placeholder="Nội dung cần hỗ trợ..."></textarea>
                            <button type="button" class="btn btn-success w-100" style="background-color: #2c5e31;">Gửi Tin Nhắn</button>
                        </form>
                    </div>
                </div>
            </div>
...
<div class="disclaimer-notice" style="font-size: 13px; color: #333; text-align: center; padding: 15px 20px; border-top: 1px solid rgba(0,0,0,0.1); background-color: transparent; line-height: 1.5; margin-top: 20px;">
  ...
  `;
    ...
    function performSearch() {
      ...
      const maxPrice = document.getElementById("maxPrice").value;f
