...
// Sửa câu SQL để thêm PaymentMethod
$sql = "SELECT o.CustomerName, o.Phone, o.Address, o.PaymentMethod, o.DateGeneration,
...
<body>
  ...
  <section>
    <div class="loca">
      ...
      <span>></span>
      <a href="#"><span>Đơn hàng: <?php echo $orderID; ?> (<?php echo getStatusText($orderStatus); ?>)</span></a>
    </div>
  ...
  <section>
    <div class="information-client">
      ...
      <div class="thongtin">
        ...
        <h5><span style="font-weight: bold;">Ngày đặt hàng:</span> <?= htmlspecialchars($orderInfo['DateGeneration']) ?></h5>
        <h5><span style="font-weight: bold;">Phương thức thanh toán:</span>
          <?php
          if ($orderInfo['PaymentMethod'] === 'COD') {
            echo 'Thanh toán khi nhận hàng';
          } else if ($orderInfo['PaymentMethod'] === 'Banking') {
            echo 'Chuyển khoản';
          } else {
            echo htmlspecialchars($orderInfo['PaymentMethod']);
          }
          ?>
        </h5>
      </div>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th style="text-align: center">ĐƠN GIÁ (VND)</th>
    ...
    <div class="cancel-order">
      ...
      <?php if ($orderStatus == 'ship'): ?>
        <div class="text-muted mt-2">Không thể hủy đơn hàng đang giao</div>
